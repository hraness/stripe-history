...
export async function llmsTxt(): Promise<string> {
  ...
  return [
    ...
    `- [Company net-revenue observations](${SITE_ORIGIN}/history/net-revenue): ${history.netRevenues.length} sourced observations`,
    ...
    `- [Stripe History repository](${GITHUB_REPOSITORY_URL}): Website code and authored YAML`,
    "",
  ].join("\n");
}
