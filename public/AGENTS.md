...
- Keep one file per canonical category and use the current `stripe-history/history/v2` schema. The namespace remains stable under the Stripedex rename. Treat `stripe-guide/history/v1` only as a legacy migration input.
