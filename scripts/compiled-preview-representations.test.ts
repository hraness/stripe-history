...
const observations = {
  ...
  "text/markdown": { status: 200, headers: { "content-type": "text/markdown; charset=utf-8", vary: "Accept" }, body: "# Stripe History: Every event in Stripe’s history, dated and sourced.\n\n## Evidence status\n" },
