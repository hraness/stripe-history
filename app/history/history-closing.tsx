  ...
  return (
    <>
      <section
        ...
        className="hraness-marketing-questions stripe-history-questions"
        data-hraness-marketing="questions"
        id="questions"
      >
        <header className="hraness-marketing-questions__header">
          <h2 className="hraness-marketing-questions__heading" id="history-questions-heading">
            About the record
          </h2>
        </header>
        <div className="hraness-marketing-question-list">
          <details className="hraness-marketing-question">
            <summary>What counts as an event?</summary>
            <div className="hraness-marketing-question__answer">
              <p>
          ...
          <details className="hraness-marketing-question">
            <summary>How are sources checked?</summary>
            <div className="hraness-marketing-question__answer">
              <p>
      ...
      <section
        ...
        className="hraness-marketing-maker stripe-history-maker"
        data-hraness-marketing="maker"
        id="maker"
      >
        <header className="hraness-marketing-maker__header">
          <h2 className="hraness-marketing-maker__heading" id="history-maker-heading">Ben Guo</h2>
        </header>
